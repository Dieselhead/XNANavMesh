...
namespace anhu07_NavMesh
{
	...
	public static class DebugShapeRenderer
	{
        ...
        /* 
        [Conditional("DEBUG")]
        public static void AddOBB(OBB box, Color color)
        {
            AddOBB(box, color, 0f);
        }

        [Conditional("DEBUG")]
        public static void AddOBB(OBB box, Color color, float life)
        {
            DebugShape shape = GetShapeForLines(12, life);

            // Fill in the vertices for the bottom of the box
            shape.Vertices[0] = new VertexPositionColor(box.DFL, color);
            shape.Vertices[1] = new VertexPositionColor(box.DFR, color);
            shape.Vertices[2] = new VertexPositionColor(box.DFR, color);
            shape.Vertices[3] = new VertexPositionColor(box.DBR, color);
            shape.Vertices[4] = new VertexPositionColor(box.DBR, color);
            shape.Vertices[5] = new VertexPositionColor(box.DBL, color);
            shape.Vertices[6] = new VertexPositionColor(box.DBL, color);
            shape.Vertices[7] = new VertexPositionColor(box.DFL, color);

            // Fill in the vertices for the top of the box
            shape.Vertices[8] = new VertexPositionColor(box.UFL, color);
            shape.Vertices[9] = new VertexPositionColor(box.UFR, color);
            shape.Vertices[10] = new VertexPositionColor(box.UFR, color);
            shape.Vertices[11] = new VertexPositionColor(box.UBR, color);
            shape.Vertices[12] = new VertexPositionColor(box.UBR, color);
            shape.Vertices[13] = new VertexPositionColor(box.UBL, color);
            shape.Vertices[14] = new VertexPositionColor(box.UBL, color);
            shape.Vertices[15] = new VertexPositionColor(box.UFL, color);

            // Fill in the vertices for the vertical sides of the box
            shape.Vertices[16] = new VertexPositionColor(box.DFL, color);
            shape.Vertices[17] = new VertexPositionColor(box.UFL, color);
            shape.Vertices[18] = new VertexPositionColor(box.DFR, color);
            shape.Vertices[19] = new VertexPositionColor(box.UFR, color);
            shape.Vertices[20] = new VertexPositionColor(box.DBL, color);
            shape.Vertices[21] = new VertexPositionColor(box.UBL, color);
            shape.Vertices[22] = new VertexPositionColor(box.DBR, color);
            shape.Vertices[23] = new VertexPositionColor(box.UBR, color);
        }
        */
